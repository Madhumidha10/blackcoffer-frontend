      ...
      <Drawer variant="permanent" open={open}>
        ...
        >
          <Typography
            ...
            sx={{ flexGrow: 1 }}
          >
            <HouseRounded sx={{ marginRight: "auto" }} /> Blackcoffer 
...
export default function Dashboard() {
  ...
  useEffect(()=>{
axios.get(`${API}/api/getAll`).then((res)=>setData(res.data.sort((a, b) => Number(new Date(b.added)) - Number(new Date(a.added)))))
  },[])
