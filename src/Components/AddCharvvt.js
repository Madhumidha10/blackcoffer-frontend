...
// color = "OrangeRed";
const [activeIndex, setActiveIndex] = useState(null),[data, setData] = useState([]);
useEffect(() => {
    d3.selectAll().data([{name:'dd',speed:5},{name:'ddww',speed:10}])
    ...
    //     });
    //     setData({name:'dd',speed:5},{name:'ddww',speed:10});
    //   });
      return () => undefined;
  }, []);
